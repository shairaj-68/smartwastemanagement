...
import { TrendingUp, Users, AlertCircle, ShoppingBag, LoaderCircle, Zap, Clock } from 'lucide-react'
      ...
      <main className="flex-1 min-w-0 transition-all duration-300 lg:px-8 py-6">
        <div className="px-6 md:px-0">
          <div className="mx-auto max-w-7xl space-y-8">
            ...
            <header className="flex items-center justify-between rounded-[2rem] border border-white/5 bg-slate-900/40 p-6 shadow-2xl backdrop-blur-sm">
            ...
            {loading && (
              <div className="flex items-center gap-3 rounded-2xl border border-white/5 bg-slate-900/40 px-4 py-3 text-sm text-slate-400">
